    ...
    <section id="counts" class="counts">
        <div class="container">
            ...
            <div class="row counters mt-5">
                <div class="col-lg-3 col-6 text-center" data-aos="fade-up" data-aos-duration="800" data-aos-delay="0">
                    <span data-toggle="counter-up"> {{ $profile_madrasah->jumlah_rombel }}</span>
                    <p>Rombongan Belajar</p>
                </div>

                <div class="col-lg-3 col-6 text-center" data-aos="fade-up" data-aos-duration="800" data-aos-delay="100">
                    <span data-toggle="counter-up"> {{ $profile_madrasah->jumlah_siswa }}</span>
                    <p>Siswa</p>
                </div>

                <div class="col-lg-3 col-6 text-center" data-aos="fade-up" data-aos-duration="800" data-aos-delay="200">
                    <span data-toggle="counter-up"> {{ $profile_madrasah->jumlah_guru }}</span>
                    <p>Guru</p>
                </div>

                <div class="col-lg-3 col-6 text-center" data-aos="fade-up" data-aos-duration="800" data-aos-delay="300">
            ...
            <div class="fw-bold kelola-data m-auto" data-aos="fade-up" data-aos-duration="800" data-aos-delay="500">
                <ul>
                    <li class="drop-down">
                        <a>Kelola Data</a>
                        <ul>
                            <li><a class="dropdown-item" href="{{ route('berita.index') }}">Edit</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
