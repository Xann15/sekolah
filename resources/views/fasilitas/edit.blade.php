    ...
    <section class="breadcrumbs">
        <div class="container">
            ...
            <section id="contact" class="contact pt-3 pb-3">
                <form action="{{ route('fasilitas.update', $fasilitas->id) }}" method="post" role="form"
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <div style="position:relative;">
                                ...
                                &nbsp;
                                <span class='label label-info' id="upload-file-info">{{ $fasilitas->foto }}</span>
                            </div>
                        </div>
                    </div>
