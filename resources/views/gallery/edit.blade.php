    ...
    <section class="breadcrumbs">
        <div class="container">
            ...
            <section id="contact" class="contact pt-3 pb-3">
                <form action="{{ route('gallery.update', $gallery->id) }}" method="post" role="form"
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <div style="position:relative;">
                                ...
                                &nbsp;
                                <span class='label label-info' id="upload-file-info">{{ $gallery->foto }}</span>
                            </div>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="penulis">Penulis</label>
                            <input type="text" class="form-control" name="penulis" id="penulis"
                                value="{{ $gallery->penulis }}" required>
                            <div class="validate"></div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="deskripsi">Deskripsi</label>
                        <textarea class="form-control summernote" id="deskripsi" name="deskripsi" required>{{ $gallery->deskripsi }}</textarea>
                        <div class="validate"></div>
                    </div>
