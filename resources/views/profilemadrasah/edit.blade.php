    ...
    <section class="breadcrumbs">
        <div class="container">
            ...
            <section id="contact" class="contact pt-3 pb-3">
                <form action="{{ route('profilemadrasah.update', $profile_madrasah->id) }}" method="post" role="form"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nama" id="nama"
                            value="{{ $profile_madrasah->nama }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="deskripsi" name="deskripsi" rows="10" data-rule="minlen:20"
                            data-msg="Deskripsi minimal 20 karakter" required>{{ $profile_madrasah->deskripsi }}</textarea>
                        <div class="validate"></div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <div style="position:relative;">
                                ...
                                <span class='label label-info'
                                    id="upload-gambar-info">{{ $profile_madrasah->gambar }}</span>
                            </div>
                        </div>
                        <div class="form-group col-md-6">
                            ...
                            <div style="position:relative;">
                                <a class='btn btn-primary' href='javascript:;'>
                                    ...
                                    <input id="logo" name="logo" type="file"
                                        style='position:absolute;z-index:2;top:0;left:0;filter: alpha(opacity=0);-ms-filter:"progid:DXImageTransform.Microsoft.Alpha(Opacity=0)";opacity:0;background-color:transparent;color:transparent;'
                                        size="40" onchange='$("#upload-logo-info").html($(this).val());'>
                                </a>
                                &nbsp;
