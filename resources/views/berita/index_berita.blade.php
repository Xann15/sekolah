                ...
                <div class="row">
                    <div class="col col-md-8 owl-carousel portfolio-details-carousel">
                        @foreach ($berita_terbaru as $data_berita)
                            <img src="{{ URL::to('/') }}/foto_berita/{{ $data_berita->foto }}" class="img-fluid"
                                alt="">
                        @endforeach
                    </div>
                    <div class="col col-md-4" style="padding-top: 38px;">
                        ...
                        @foreach ($berita_terbaru as $berita)
                            <div class="product-img">
                                <img src="{{ URL::to('/') }}/foto_berita/{{ $berita->foto }}" alt="img-thumbnail"
                                    style="width: 80px;">
                                <a href="/berita/{{ $berita->id }}" target="_blank"
                                    class="product-title">{!! substr($berita->judul, 0, 18) !!}.....
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-heading post-thumb">
                                    <img class="card-img-top"
                                        src="{{ URL::to('/') }}/foto_berita/{{ $data_berita->foto }}" />
                                </div>

                                <div class="panel-body post-body-berita">
                                    <a href="/berita/{{ $data_berita->id }}" target="_blank">
                                    ...
                                    <a href="/berita/{{ $data_berita->id }}" target="_blank">Baca selengkapnya</a>
                                </div>
                            </div>
                        </div>
                    @endforeach
